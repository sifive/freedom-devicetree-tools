...
#ifndef __BARE_HEADER_SYNOPSYS_I2S_MASTER_V1_11A__H
#define __BARE_HEADER_SYNOPSYS_I2S_MASTER_V1_11A__H

#include "bare_header/device.h"

#include <regex>

class synopsys_i2s_master_v1_11a : public Device {
  public:
    synopsys_i2s_master_v1_11a(std::ostream &os, const fdt &dtb)
