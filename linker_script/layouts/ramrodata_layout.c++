...
RamrodataLayout::RamrodataLayout(const fdt &dtb, Memory rom_memory,
  ...
  if (itim_memory.size >= MAGIC_RAMRODATA_TEXT_THRESHOLD) {
    ...
    section_groups.push_back(
        InitTextGroup(rom_memory, rom_phdr,   /* Init code is loaded from ROM */
    ...
    section_groups.push_back(ItimTextGroup(
