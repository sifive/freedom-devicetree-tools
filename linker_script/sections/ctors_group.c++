...
CtorsGroup::CtorsGroup(Memory logical_memory, Phdr logical_header,
  ...
  init_array.add_command("KEEP (*(SORT_BY_INIT_PRIORITY(.init_array.*) "
                         "SORT_BY_INIT_PRIORITY(.ctors.*)))");
  init_array.add_command("KEEP (*(.init_array EXCLUDE_FILE (*crtbegin.o "
  ...
  fini_array.add_command("KEEP (*(SORT_BY_INIT_PRIORITY(.fini_array.*) "
                         "SORT_BY_INIT_PRIORITY(.dtors.*)))");
  fini_array.add_command("KEEP (*(.fini_array EXCLUDE_FILE (*crtbegin.o "
