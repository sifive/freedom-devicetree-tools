...
#ifndef __DEFAULT_BULLET_STRATEGY__H
#define __DEFAULT_BULLET_STRATEGY__H
...
class DefaultBulletStrategy : public MapStrategy {
  public:
...
#endif /* __DEFAULT_BULLET_STRATEGY__H */
