...
#ifndef __DEFAULT_E20_ARTY_STRATEGY__H
#define __DEFAULT_E20_ARTY_STRATEGY__H
...
class DefaultE20ArtyStrategy : public MapStrategy {
  public:
...
#endif /* __DEFAULT_E20_ARTY_STRATEGY__H */
