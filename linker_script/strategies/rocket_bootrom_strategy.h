...
#ifndef __ROCKET_BOOTROM_STRATEGY__H
#define __ROCKET_BOOTROM_STRATEGY__H
...
class RocketBootromStrategy : public MapStrategy {
  public:
...
#endif /* __ROCKET_BOOTROM_STRATEGY__H */
