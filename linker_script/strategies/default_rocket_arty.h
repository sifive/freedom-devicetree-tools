...
#ifndef __DEFAULT_ROCKET_ARTY_STRATEGY__H
#define __DEFAULT_ROCKET_ARTY_STRATEGY__H
...
class DefaultRocketArtyStrategy : public MapStrategy {
  public:
...
#endif /* __DEFAULT_ROCKET_ARTY_STRATEGY__H */
