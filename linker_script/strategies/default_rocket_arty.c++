...
bool DefaultRocketArtyStrategy::valid(const fdt &dtb,
...
LinkerScript
DefaultRocketArtyStrategy::create_layout(const fdt &dtb,
                                         list<Memory> available_memories,
  ...
  print_chosen_strategy("DefaultRocketArtyStrategy", link_strategy, ram_memory,
