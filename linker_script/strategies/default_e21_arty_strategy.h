...
#ifndef __DEFAULT_E21_ARTY_STRATEGY__H
#define __DEFAULT_E21_ARTY_STRATEGY__H
...
class DefaultE21ArtyStrategy : public MapStrategy {
  public:
...
#endif /* __DEFAULT_E21_ARTY_STRATEGY__H */
