...
synopsys_i2s_master_v1_11a::synopsys_i2s_master_v1_11a(std::ostream &os, const fdt &dtb)
    : Device(os, dtb, "synopsys_i2s_master_v1_11a") {}


/* Certain devices need to create #defines at the top of the header.
 * Those defines should be output here */
void synopsys_i2s_master_v1_11a::create_defines() {
  ...
  emit_def("METAL_MAX_I2S_MASTER_INTERRUPTS", std::to_string(max_interrupts));
}

/* This method includes the header file */
void synopsys_i2s_master_v1_11a::include_headers() {
...
void synopsys_i2s_master_v1_11a::declare_structs() {
...
void synopsys_i2s_master_v1_11a::create_handles() {

      emit_def("__METAL_DT_MAX_I2S_MASTER", std::to_string(num_i2s));

  emit_struct_pointer_begin("synopsys_i2s", "__metal_i2s_master_table", "[]");
  if (num_i2s) {
    int i = 0;
    dtb.match(std::regex(compat_string), [&](node n) {
...
void synopsys_i2s_master_v1_11a::define_inlines() {
...
Inline *base_func;
  ...
  dtb.match(std::regex(compat_string), [&](node n) {
    ...
    n.maybe_tuple("master_interrupt-parent", tuple_t<node>(), [&]() {},
                  [&](node m) {
    ...
    n.maybe_tuple("master_clocks", tuple_t<node>(), [&]() {},
                  [&](node m) {
    ...
    if (count == 0) {
      base_func = create_inline_def(
          "master_control_base", "unsigned long",
...
void synopsys_i2s_master_v1_11a::declare_inlines() {
...
Inline *func;
  ...
  dtb.match(std::regex(compat_string), [&](node n) {
    if (count == 0) {
      func = create_inline_dec("master_control_base", "unsigned long",
                               "struct metal_i2s *i2s");
      extern_inlines.push_back(func);

      func = create_inline_dec("master_control_size", "unsigned long",
                               "struct metal_i2s *i2s");
      extern_inlines.push_back(func);

      func =
          create_inline_dec("master_num_interrupts", "int", "struct metal_i2s *i2s");
      extern_inlines.push_back(func);

      func = create_inline_dec("master_interrupt_parent", "struct metal_interrupt *",
                               "struct metal_i2s *i2s");
      extern_inlines.push_back(func);

      func =
          create_inline_dec("master_interrupt_line", "int", "struct metal_i2s *i2s");
      extern_inlines.push_back(func);

      func = create_inline_dec("master_clock", "struct metal_clock *",
                               "struct metal_i2s *i2s");
      extern_inlines.push_back(func);
...
void synopsys_i2s_master_v1_11a::define_structs() {
