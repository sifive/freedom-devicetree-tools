...
sifive_global_external_interrupts0::sifive_global_external_interrupts0(std::ostream &os, const fdt &dtb)
...
void sifive_global_external_interrupts0::declare_inlines()
{
  ...
  dtb.match(
    ...
    [&](node n) {
      if (count == 0) {
	func = create_inline_dec("init_done",
				 "int",
				 " ");
...
void sifive_global_external_interrupts0::define_inlines()
{
  ...
  dtb.match(
    ...
    [&](node n) {
      if (count == 0) {
	func = create_inline_def("init_done",
				 "int",
				 "empty",
				 "0",
				 "");
